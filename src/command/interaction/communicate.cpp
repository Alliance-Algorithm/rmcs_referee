...
public:
    Communicate()
        ...
        position_publisher_ =
            create_publisher<std_msgs::msg::Float32MultiArray>("/unit_info/enemy/position", 10);
        hp_publisher_ = create_publisher<std_msgs::msg::Float32MultiArray>("/unit_info/enemy/hp", 10);
        bullet_count_publisher_ = create_publisher<std_msgs::msg::Int32>("/referee/sentry/bullet", 10);
